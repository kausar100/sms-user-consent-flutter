...
class SmsUserConsentMe {
  static const MethodChannel _channel = MethodChannel('sms_user_consent_me');
  ...
  SmsUserConsentMe({Function? phoneNumberListener, Function? smsListener}) {
